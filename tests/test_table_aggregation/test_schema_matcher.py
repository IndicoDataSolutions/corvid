...
class ColumnValueSchemaMatcher(unittest.TestCase):
    ...
    def test_map_tables(self):
        ...
        self.assertListEqual(schema_matcher.map_tables(
            tables=[self.table_source, self.table_extra_rows],
            target_schema=target_schema_easy
        ),
            ...
            [
                ...
                PairwiseMapping(self.table_extra_rows,
                                target_schema_easy,
                                score=2.0,
                                column_mappings=[(1, 1), (2, 2)])
            ])
        ...
        self.assertListEqual(schema_matcher.map_tables(
            tables=[self.table_source, self.table_permute_rows],
            target_schema=target_schema_less
        ),
            ...
            [
                ...
                PairwiseMapping(self.table_permute_rows,
                                target_schema_less,
                                score=1.0,
                                column_mappings=[(1, 2)])
            ])
        ...
        [
            ...
            PairwiseMapping(self.table_missing_rows,
                            target_schema_less,
                            score=1.0,
                            column_mappings=[(1, 2)])
        ])
        ...
        self.assertListEqual(schema_matcher.map_tables(
            tables=[self.table_source, self.table_source,
                    self.table_source],
            target_schema=target_schema_easy
        ),
